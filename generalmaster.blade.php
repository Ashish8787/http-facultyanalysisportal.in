            ...
            <div class="container-fluid" style="background: brown">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="aboutus" id="menu">ABOUT US</a></li>
                        <li><a href="gallery" id="menu">GALLERY</a></li>
                        <li><a href="events" id="menu">EVENTS</a></li>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title text text-center" id="myModalLabel" style="font-size:30px;font-family:'times new roman';color:maroon;">Login Panel</h4>
                                                </div>
                                                <div class="modal-body">

                                                    <label style="font-size:30px;font-family:thomba;color:maroon;">User Id</label>
                                                    <input type="text" placeholder="Enter your Id" class="form-control"/>
                                                    <label style="font-size:30px;font-family:thomba;color:maroon;">Password</label>
                                                    <input type="password" placeholder="Enter your Password" class="form-control"/><br>
                                                    <input type="button" value="Login" class="btn btn-danger"/>
                                                </div>
