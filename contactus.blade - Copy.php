...
<div class="container-fluid" style="min-height: 400px;">
    <div class="row text text-center" style="min-height: 50px;font-size: 30px; font-family: thomba;color: maroon; ">Contact US</div>
    <div class="row">
                ...
                <div class="row">
                    <div class="col-sm-12" style="border: 2px; solid red">
                        ...
                        <div class="col-sm-6" >
                            ...
                            <label style="font-size: 20px;color: maroon;font-family: thomba">Massage</label>
                            <input type="text" name="txtcomm" placeholder="Enter Massage"  class="form-control"/><br>
